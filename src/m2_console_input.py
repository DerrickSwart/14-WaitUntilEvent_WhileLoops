...
def double_a_float():
    ...
    # -------------------------------------------------------------------------
    x = float(input('enter an integer to be doubled   '))
    print (x * 2)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    x = float(input(' enter float for sqrt         '))
    y = int(input('enter interger for iterations   '))
    z = input('enter string to be repeated         ')
    for _ in range (y):
        print((math.sqrt(x)))
    for i in range (y):
        print(z)
